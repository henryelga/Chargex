    ...
    func fetchChargingStations(completion: @escaping ([ChargingStation]) -> Void) {
        ...
        do {
            ...
            let stations: [ChargingStation] = elements.compactMap { element in
                ...
                if lat == nil, let center = element["center"] as? [String: Double] {
                    lat = center["lat"]
                    lon = center["lon"]
                }
                ...
                let voltage = tags?["voltage"] as? String
                let amperage = tags?["amperage"] as? String
                ...
                return ChargingStation(
                    ...
                    phone: phone,
                    type2: type2,
                    type2Combo: tags?["socket:type2_combo"] as? String,
                    chademo: chademo,
